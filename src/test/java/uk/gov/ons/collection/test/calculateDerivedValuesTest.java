...
class calculateDerivedValuesTest {
    ...
    String responseInput = "{" + "\"data\": {" + "\"allResponses\": {" + "\"nodes\": [" + "{" + "\"response\": \"20\","
            + "\"questioncode\": \"1000\"," + "\"instance\": 0" + "}," + "{" + "\"response\": \"1\","
            + "\"questioncode\": \"1001\"," + "\"instance\": 0}," + "{" + "\"response\": \"1\","
            + "\"questioncode\": \"2000\"," + "\"instance\": 0}," + "{" + "\"response\": \"Rhubarb\","
            + "\"questioncode\": \"3000\"," + "\"instance\": 0}," + "{" + "\"response\": \"21\","
            + "\"questioncode\": \"4000\"," + "\"instance\": 0}," + "{" + "\"response\": \"19\","
            + "\"questioncode\": \"4001\"," + "\"instance\": 0}" + "]" + "}" + "}" + "}";
    ...
    void incorrectJSON_returnsInvalidJsonException() {
        String incorrectFormInput = "\"allContributors\": {" + "\"nodes\": [" + "{" + "\"formByFormid\": {"
                ...
                + "\"derivedformula\": \"\"" + "}," + "{" + "\"questioncode\": \"1001\"," + "\"derivedformula\": \"\""
                + "}," + "{" + "\"questioncode\": \"2000\"," + "\"derivedformula\": \"\"" + "}," + "{"
                + "\"questioncode\": \"3000\"," + "\"derivedformula\": \"\"" + "}," + "{"
                + "\"questioncode\": \"4000\"," + "\"derivedformula\": \"1000 + 1001\"" + "}," + "{"
                + "\"questioncode\": \"4001\"," + "\"derivedformula\": \"1000 - 1001\"" + "}" + "]" + "}" + "}" + "}"
                + "]" + "}" + "}" + "}";

        Assertions.assertThrows(InvalidJsonException.class, () -> {
            new CalculateDerivedValuesResponse(incorrectFormInput, responseInput);
        });
    }

    @Test
    void parseFormData_returnsExpectedOutput_validInput() {
        var expectedOutput = "{" + "\"form_data\":[" + "{" + "\"derivedformula\":\"\"," + "\"questioncode\":\"1000\""
                + "}," + "{" + "\"derivedformula\":\"\"," + "\"questioncode\":\"1001\"" + "}," + "{"
                + "\"derivedformula\":\"\"," + "\"questioncode\":\"2000\"" + "}," + "{" + "\"derivedformula\":\"\","
                + "\"questioncode\":\"3000\"" + "}," + "{" + "\"derivedformula\":\"1000 + 1001\","
                + "\"questioncode\":\"4000\"" + "}," + "{" + "\"derivedformula\":\"1000 - 1001\","
                + "\"questioncode\":\"4001\"" + "}" + "]" + "}";
        JSONObject response = new JSONObject();
        try {
            response = new CalculateDerivedValuesResponse(formInput, responseInput).parseFormData();
        } catch (Exception e) {
    ...
    void parseResponseData_returnsExpectedOutput_validInput() {
        ...
        var expectedOutput = "{" + "\"response_data\":[" + "{" + "\"instance\":0," + "\"response\":\"20\","
                + "\"questioncode\":\"1000\"" + "}," + "{" + "\"instance\":0," + "\"response\":\"1\","
                + "\"questioncode\":\"1001\"" + "}," + "{" + "\"instance\":0," + "\"response\":\"1\","
                + "\"questioncode\":\"2000\"" + "}," + "{" + "\"instance\":0," + "\"response\":\"Rhubarb\","
                + "\"questioncode\":\"3000\"" + "}," + "{" + "\"instance\":0," + "\"response\":\"21\","
        ...
        JSONObject response = new JSONObject();
        try {
            response = new CalculateDerivedValuesResponse(formInput, responseInput).parseResponseData();
        } catch (Exception e) {
    ...
    void calculateDerviedValues_returnsExpectedValues() {
        ...
        try {
            response = new CalculateDerivedValuesResponse(formInput, responseInput).calculateDerivedValues();
        } catch (Exception e) {
    ...
    void calculateDerviedValues_decimalInput_returnsDecimalValues() {
        var responseDecimalInput = "{" + "\"data\": {" + "\"allResponses\": {" + "\"nodes\": [" + "{"
                + "\"response\": \"20.345\"," + "\"questioncode\": \"1000\"," + "\"instance\":0" + "}," + "{"
                + "\"response\": \"1.343\"," + "\"questioncode\": \"1001\"," + "\"instance\":0" + "}," + "{"
                + "\"response\": \"1\"," + "\"questioncode\": \"2000\"," + "\"instance\":0" + "}," + "{"
                + "\"response\": \"Rhubarb\"," + "\"questioncode\": \"3000\"," + "\"instance\":0" + "}," + "{"
                + "\"response\": \"21\"," + "\"questioncode\": \"4000\"," + "\"instance\":0" + "}," + "{"
        ...
        ArrayList<HashMap<String, Object>> response = new ArrayList<>();
        try {
            response = new CalculateDerivedValuesResponse(formInput, responseDecimalInput).calculateDerivedValues();
        } catch (Exception e) {
            System.out.println("Can't calculate derived values" + e);
        }
        assertEquals(expectedOutput, response.toString());
    ...
    void calculateDerviedValues_stringResponseInput_returnsError() {
        ...
        Assertions.assertThrows(InvalidDerivedResponseException.class, () -> {
            new CalculateDerivedValuesResponse(formInput, responseStringInput).calculateDerivedValues();
        });
    }
    ...
    void updateDerivedResponses_validInput_returnsExpectedData() {
        ...
        JSONObject response = new JSONObject();
        try {
            response = new CalculateDerivedValuesResponse(formInput, responseInput)
    ...
    void calculateDerviedValues_blankResponseInput_convertsToZero() {
        ...
        ArrayList<HashMap<String, Object>> response = new ArrayList<>();
        try {
            response = new CalculateDerivedValuesResponse(formInput, responseStringInput).calculateDerivedValues();
        } catch (Exception e) {
            System.out.println("Can't calculate derived values" + e);
        }
        assertEquals(expectedOutput, response.toString());
    ...
    void incorrectFormula_returnsDerivedResponseException() {
        ...
        Assertions.assertThrows(FormulaCalculationException.class, () -> {
            new CalculateDerivedValuesResponse(incorrectFormInput, responseInput).calculateDerivedValues();
        });
    }
    ...
    void incorrectFormulaFormat_returnsResultEqualsZero() {
        ...
        ArrayList<HashMap<String, Object>> response = new ArrayList<>();
        try {
            response = new CalculateDerivedValuesResponse(incorrectFormInput, responseInput).calculateDerivedValues();
        } catch (Exception e) {
            System.out.println("Can't calculate derived values" + e);
        }
        assertEquals(expectedOutput, response.toString());
    ...
    void noDerivedFormulas_returnsEmptyArray() {
        ...
        JSONObject response = new JSONObject();
        try {
            response = new CalculateDerivedValuesResponse(incorrectFormInput, responseInput)
                    .updateDerivedQuestionResponses();
        } catch (Exception e) {
            System.out.println("Can't calculate derived values" + e);
        }
